...
labels:
  ...
  - HR Systems
summary: "IT and HR systems support for the Recruiting and Employment Services branch, including employment records server migrations and NEOED system administration."
---
...
- Reassigning and managing user permissions across staff and contractor accounts
- Overriding system-level issues to unblock HR processing workflows
- Assisting with the processing and maintenance of employment records
- Supporting end users across the branch with system navigation and troubleshooting

<img src="../img/neoed_logo.png" alt="neoed-logo" fluid style="max-width: 100%; height: auto;" />

<hr />

## Server Upgrades & Data Migration
